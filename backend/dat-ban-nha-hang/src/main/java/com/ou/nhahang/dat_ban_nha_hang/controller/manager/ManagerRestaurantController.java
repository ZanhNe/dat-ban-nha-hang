...
public class ManagerRestaurantController {
    ...
    public ManagerRestaurantController(IManagerRestaurantService managerRestaurantService) {
    ...
    public ResponseEntity<ApiResponse<ManagerRestaurantResponseDTO>> getRestaurantInfo(
        ...
        ManagerRestaurantResponseDTO data = managerRestaurantService.getRestaurantDetail(restaurantId, managerId);
