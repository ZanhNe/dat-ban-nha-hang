...
public interface IManagerStaffService {
    Page<ManagerStaffResponseDTO> getStaffs(Long managerId, ManagerStaffRequestDTO.GetStaffs requestDTO);

    ManagerStaffResponseDTO createStaff(Long managerId, ManagerStaffRequestDTO.CreateStaff requestDTO);
